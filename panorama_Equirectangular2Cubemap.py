...
for img_ID in range(0, 3000, 30):
    # read  
    img = cv2.imread(r'./data/images/video2img/pano_equi_{}.jpg'.format(img_ID))
    ...
    # write
    cv2.imwrite(r'./data/images/video2img_processed/pano_corr_{}.jpg'.format(img_ID), img)
...
########## video ##########
# read video
cap = cv2.VideoCapture(r'./data/images/panorama_equirectangular.mp4')

SIZE = 300 # 4/6 cubemap img size

# write videl
fourcc = cv2.VideoWriter_fourcc('m', 'p', '4', 'v')
out = cv2.VideoWriter(r'./data/images/panorama_correction.mp4', fourcc, 20.0, (SIZE*4, SIZE*1))
